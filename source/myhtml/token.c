...
void myhtml_token_adjust_svg_attributes(myhtml_token_node_t *target) {
	size_t i, count = sizeof(myhtml_token_attr_svg_replacement) / sizeof(myhtml_token_replacement_entry_t);
...
void myhtml_token_adjust_foreign_attributes(myhtml_token_node_t *target) {
	size_t i, count = sizeof(myhtml_token_attr_namespace_replacement) / sizeof(myhtml_token_namespace_replacement_t);
